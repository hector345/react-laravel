...
<body>
    ...
    <main>
        <div class="container">
            <div class="row">
                {{--formulario title, excerpt, content--}}
                <h1>Editar </h1>
                <form action="/posts" method="POST">
                    ...
                    <div class="input-field col s12">
                        <textarea id="excerpt" name="excerpt" class="materialize-textarea">{{$post->excerpt}}</textarea>
                    ...
                    {{--boton submit--}}
                    <button class="btn waves-effect waves-light" type="submit" name="action">Actualizar <i
